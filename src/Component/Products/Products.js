    ...
    <Container>
      ...
      >
        <Box>
          ...
          >
            Shop of all categories
          </Typography>
          <Typography color="text.secondary" sx={{ textAlign: "left" }}>
            We are providing shopping in resturant,medicine and shopping{" "}
          </Typography>
        </Box>
        <Button
          onClick={() => allresturant("resturant")}
          className={category === "resturant" ? "selected" : ""}
        ...
        <Button
          ...
          variant="text"
          className={category === "medicine" ? "selected" : ""}
        >
          Medicines
        </Button>
        <Button
          onClick={() => allsupershop("supershop")}
          sx={{
            color: `${darkMode ? "white" : "gray"} `,
            fontWeight: "bold",
            mr: 1,
          ...
          variant="text"
          className={category === "supershop" ? "selected" : ""}
        >
          Super Shops
        </Button>
      </Box>
      ...
      >
        {alldata.map((data, index) => (
          <Product key={index} service={data} isLoad={isLoad} />
        ))}
      </Grid>
    </Container>
  );

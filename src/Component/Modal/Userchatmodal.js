              ...
              <div class="chatbox">
                <div class="chatbox-top">
                  ...
                  <div class="chat-partner-name">
                    ...
                    <a target="_blank" href="https://www.facebook.com/turjoy2">
                      {riderallinfo.fname}
                    </a>
                  </div>
                ...
                <div className="chat-messages">
                  <ScrollableFeed>
                    {messages
                      ?.filter(
                        (data) =>
                          data.allmessage.message.userid === userdata?._id &&
                          data.allmessage.message.riderid === riderallinfo?._id
                      )
                      .map((el) => {
                        return (
                          <>
                            <div className="message-box-holder">
                              <div className="message-sender">
                                {el.allmessage.message.status == "user"
                                  ? "me"
                                  : riderallinfo.fname}
                              </div>

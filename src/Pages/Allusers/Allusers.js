            ...
            return (
              <Grid item lg={3} md={4} sm={6} xs={12} key={info._id}>
                <div className="card-container">
                  <span className="pro" style={{ backgroundColor: "green" }}>
                    Online
                  </span>
                  <img
                    className="round"
                    src="https://static.vecteezy.com/system/resources/thumbnails/002/002/332/small/ablack-man-avatar-character-isolated-icon-free-vector.jpg"
                    height="120px"
                    width="120px"
                    alt="user"
                  />

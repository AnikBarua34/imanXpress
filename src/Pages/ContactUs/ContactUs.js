...
const ContactUs = () => {
  ...
  return (
    <div className="font">
      ...
      <Container sx={{ mb: 3 }}>
        <Typography
          sx={{ textAlign: "center", m: 2, mt: 3, fontWeight: "bold" }}
          variant="h5"
        >
        ...
        <Typography sx={{ textAlign: "center", width: "50%" }} variant="p">
          Iman Xpress is always open and We care about our customers, so you
          will get support 24 hours in a day and 7 days in a week. We help to
          save customers time.
        </Typography>
        {/* SOcial Links  */}
        ...
        <Grid sx={{ mt: 2 }} container spacing={2}>
          <Grid item xs={12} lg={6} md={6}>
            ...
            <Item sx={{ display: "flex", boxShadow: 3 }}>
              <Typography
                sx={{ bgcolor: "light", borderRadius: "90%", mt: 1, mr: 1 }}
                variant="h5"
              >
            ...
            <Item sx={{ display: "flex", boxShadow: 3 }}>
              ...
              <Typography variant="h6">
                ...
                >
                  imanxpress247@gmail.com
                  <br />
                  anikbaruaturjoy45@gmail.com
                  <br />
                </Typography>
              </Typography>
            </Item>
          ...
          <Grid item xs={12} lg={6} md={6}>
            <Item>
              <Typography
                sx={{ textAlign: "left", boxShadow: 3, p: 1 }}
                variant="h5"
              >
                Send us Message
              </Typography>
